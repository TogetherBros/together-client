...
4. 입장하면 친구들의 캐릭터가 바탕화면 위에 나타납니다
...
**바탕화면 오버레이**  
친구들 캐릭터가 화면 하단에 떠다닙니다. 클릭해서 원하는 위치로 이동할 수 있어요.
...
트레이 아이콘을 우클릭하면 열기 · 방 나가기 · 종료 메뉴가 나타납니다.

---

## 캐릭터

입장 시 6종 중 하나가 랜덤 배정됩니다. 같은 방 안에서 같은 캐릭터는 나오지 않아요.
